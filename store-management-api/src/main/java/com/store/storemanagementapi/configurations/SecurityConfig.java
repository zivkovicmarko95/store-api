package com.store.storemanagementapi.configurations;

import com.store.storemanagementapi.utils.KeycloakRoleConverter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private final String[] permitUrls = { "/api/stores/**", "/v2/api-docs", "/swagger-resources/**", "/configuration/ui", "/swagger-ui/**", "/actuator/health/**" };
