...
class ProductInternalRemoveDeleteByIdMockMvcTest {
    ...
    void internalProductsProductIdRemoveDelete() throws Exception {
        ...
        when(this.productControllerHelper.internalProductsProductIdRemoveDelete(productId))
                .thenReturn(deleteResultTO);

        this.mockMvc.perform(delete(ApiTestConstants.INTERNAL_PRODUCTS_WITH_ID_REMOVE, productId))
        ...
        verify(this.productControllerHelper).internalProductsProductIdRemoveDelete(productId);
    }
