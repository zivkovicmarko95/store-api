...
class AccountInternalDeleteByIdMockMvcTest {
    ...
    void internalAccountsAccountIdDelete() throws Exception {
        ...
        when(this.accountControllerHelper.internalAccountsAccountIdDelete(accountId))
            .thenReturn(deleteResultTO);

        this.mockMvc.perform(delete(ApiTestConstants.INTERNAL_ACCOUNTS_WITH_ID, accountId))
        ...
        verify(this.accountControllerHelper).internalAccountsAccountIdDelete(accountId);
    }
