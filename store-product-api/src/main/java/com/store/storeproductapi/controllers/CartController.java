...
public class CartController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<CartTO> cartsCartIdGet(final String id) {
    ...
    @PostMapping
    public ResponseEntity<CartTO> cartsPost(final CartCreate cartCreate) {
    ...
    @PostMapping("/add")
    public ResponseEntity<CartTO> cartsAddPost(final Cart cart) {
    ...
    public ResponseEntity<CartTO> cartsRemoveDelete(final Cart cart) {
