...
public class InternalAccountController {
    ...
    public ResponseEntity<AccountTO> internalAccountsAccountSubjectIdGet(final String subjectId) {
    ...
    public ResponseEntity<DeleteResultTO> internalAccountsAccountIdDelete(final String accountId) {
    ...
    public ResponseEntity<AccountTO> internalAccountsAccountIdInactiveDelete(final String accountId) {
